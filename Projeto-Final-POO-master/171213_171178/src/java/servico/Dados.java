...
public class Dados {
    ...
    public static void init() {
        ...
        LISTA_CLIENTES.add(new Cliente(2, "JamiScript", "Rua Verão", "8957417", 2, 0.10));
        LISTA_CLIENTES.add(new Cliente(3, "Gustov", "Rua Primavera", "95103570", 3, 15000));
        LISTA_CLIENTES.add(new Cliente(4, "Vinimybad", "Rua Outono", "77111992", 1, 1000));
        LISTA_CLIENTES.add(new Cliente(5, "Quévinho", "Rua Primavera", "156592956", 2, 180.10));
